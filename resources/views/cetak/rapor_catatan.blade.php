            ...
            <table width="auto">
               <tr>
                  <td style="text-align: left;">
                     ...
                     @if ($get_siswa->rombongan_belajar->wali_kelas->ttd)
   ...
   <table width="100%" style="margin-top:10px;">
      <tr>
         ...
         <td style="width:60%;">
            ...
            <br />
            @if (App\Models\Guru::where('guru_id', $get_siswa->peserta_didik->sekolah->kasek->guru_id)->first()->ttd)
               @if (App\Models\Guru::where('guru_id', $get_siswa->peserta_didik->sekolah->kasek->guru_id)->first()->ttd->tampil == 'ya')
                  <img
                     src="{{ public_path(App\Models\Guru::where('guru_id', $get_siswa->peserta_didik->sekolah->kasek->guru_id)->first()->ttd->lokasi) }}"
                     style="width: 120px" />
               @else
                  <br>
                  <br>
